...
################################################################################
  ...
  # Cjkjvfnby, shokkueibu, UndeadDuke, Dj_FRedy.
...
try_for_agents          =   12  # (try_for_agents, <destination>, [<position>], [<value>]),
                                # Runs a cycle, iterating all agents on the scene. Optional parameters allow to check agents only within specific radius around certain position.
